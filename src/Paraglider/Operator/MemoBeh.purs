...
memoBeh :: forall m a t r. Applicative m => MonadST t m => Event a -> a -> (Event a -> r) -> Event r
memoBeh e a f = memoBehInternal e (Just a) f

-- | A memoized event that acts like a behavior, emitting immediately
-- | the most recent value to all subscribers.
memoBeh' :: forall m a t r. Applicative m => MonadST t m => Event a -> (Event a -> r) -> Event r
